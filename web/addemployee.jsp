            ...
            <main role="main">
                ...
                <div class="form-control w-25 m-auto p-3">
                    <form action="AddEmployee" method="Post">
                        ...
                        <input type="number" class="form-control" id="floatingInput" placeholder="carAllowance" name="carAllaowance" value="0" required>
                ...
                <footer class="container">
                    <h5>&laquo; &copy; Exavalu 2022-2023 &raquo;</h5>
                </footer>
            </div>         
        </main>
    </body>
