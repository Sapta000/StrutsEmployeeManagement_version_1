<%-- 
    ...
    Created on : Feb 5, 2023, 2:49:49 PM
    Author     : sapta
--%>
            ...
            <main role="main">
                <div class="jumbotron">
                    ...
                    <form action="SaveEmployee" method="Post">
                        ...
                        <input type="text" class="form-control" id="floatingInput" placeholder="carAllowance" name="carAllaowance" value="${emp.getCarAllowance()}">
